    ...
    if (!isBodyApplicable) {
      return (
        <p style={{ color: '#6c757d', fontSize: '0.9em' }}>
          {t('request_body_not_applicable', { method })}
        </p>
      );
    }
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        {bodyKeyValuePairs.map((pair, index) => (
          <div key={pair.id} style={{ display: 'flex', gap: '5px', alignItems: 'center' }}>
            <input
              ...
              title={pair.enabled ? t('disable_row') : t('enable_row')}
        ...
        <div style={{ display: 'flex', gap: '8px', marginTop: '10px' }}>
          ...
          <button
            ...
            style={{ padding: '8px 15px', fontSize: '0.95em', backgroundColor: '#6c757d', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }}
          >
            {t('import_json')}
          </button>
            ...
            >
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '10px' }}>
                <button
                  ...
                  style={{ padding: '8px 12px', border: '1px solid #ccc', backgroundColor: 'white', borderRadius: '4px' }}
                >
                  {t('cancel')}
                </button>
                <button
